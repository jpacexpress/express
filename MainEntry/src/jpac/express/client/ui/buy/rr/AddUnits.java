...
public class AddUnits extends CustomWindow {
	...
	public void showAddUnits(String fieldsName) {
		...
		unitsDetailsForm.getField(Constants.ADDFORM_FIELDS_SHORTNAME).setValue(Constants.ADDFORM_FIELDSTITLE_SHORTNAME);
		unitsDetailsForm.getField(Constants.ADDFORM_FIELDS_DETAILS).setValue(Constants.ADDFORM_FIELDSTITLE_DETAILS);		
		unitsIdForm.setCanEdit(true);
		centerInPage();
		show();
		unitsIdForm.focusInItem(Constants.UNITS_UNITSID);
	}
	...
	private void initWidgets() {
		...
		//unitsDetailsForm.setDataSource(GoodsAllSizeUnitsDS.getInstance());
		...
		shortNameDescription = new StaticTextItem(Constants.ADDFORM_FIELDS_SHORTNAME);
		shortNameDescription.setShowTitle(false);
		...
		detailsDescription = new StaticTextItem(Constants.ADDFORM_FIELDS_DETAILS);
		...
		unitsDetailsForm.setFields(autoId,unitsId, shortNameDescription, detailsDescription, unitsShortNameTH, unitsFullNameTH, unitsShortNameEN, unitsFullNameEN);
		unitsDetailsForm.hideItem(Constants.UNITS_UNITSID);
		unitsDetailsForm.hideItem(Constants.IDS);
